...
namespace BagOfNonsense.Projectiles
{
    ...
    {
        public override void SetStaticDefaults() => DisplayName.SetDefault("Phantasmal Missile");
            ...
            if (flag13 && Main.myPlayer == projectile.owner)
            {
                ...
                if (flag14)
                {
                    ...
                    for (int m = 0; m < 1; m++)
                    {
                        ...
                        Projectile.NewProjectile(value16.X, value16.Y, spinningpoint2.X, spinningpoint2.Y, ModContent.ProjectileType<Hiddenproj>(), weaponDamage, weaponKnockback, projectile.owner, 0f, 0f);
                        for (int i = 0; i < 2; i++)
                        {
                            ...
                            var proj = Projectile.NewProjectile(value16.X, value16.Y, speeen.X, speeen.Y, num38, weaponDamage, weaponKnockback, projectile.owner, 0f, 0f);
