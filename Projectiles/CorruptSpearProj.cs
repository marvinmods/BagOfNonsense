...
namespace BagOfNonsense.Projectiles
{
    ...
    {
        public override void SetStaticDefaults() => DisplayName.SetDefault("Javelin");
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                // Create a new dust
                var dust = Dust.NewDustDirect(usePos, projectile.width, projectile.height, 184, default);
        ...
        public override void ModifyHitNPC(NPC target, ref int damage, ref float knockback, ref bool crit, ref int hitDirection)
        {
            ...
            target.AddBuff(ModContent.BuffType<CorruptTouch>(), 900);
        ...
        private void NormalAI()
        {
            ...
            {
                var dust = Dust.NewDustDirect(projectile.position, projectile.height, projectile.width, 184,
                    projectile.velocity.X * .2f, projectile.velocity.Y * .2f, 175, default, Scale: 1.2f);
        ...
        private void StickyAI()
        {
            ...
            const int AI_FACTOR = 15; // Change this factor to change the 'lifetime' of this sticking javelin
